  ...
  <aside id="sidebar" class="affix">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
        ...
        <li>
          <a class="back" href="<?php echo U("Lianxi/class_list"); ?>"><span class="glyphicons"><div style="width:50%;margin:auto;"><img width="100%"src="/ThinkPHP/Public/Admin/images/icon_22.png" style="margin-top:15px;"></div></span><span class="sidebar-title">联系我们</span></a>
        </li>
        <li>
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  <div class="panel-title">联系列表</div>
                  <a href="<?php echo U("Lianxi/add"); ?>" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加文章</a>
                </div>
                ...
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-bordered table-hover dataTable">
					  ...
					  <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr class="success">
                        ...
                        <td><?php echo str_cut($value['content'],0,20,'utf8','...')?></td>
                        <td><img src="/ThinkPHP/Uploads/<?php echo ($value["img"]); ?>" width="100px" height="100px"></td>
                        <td><?php echo date("Y-m-d h:i:s",$value['times']);?></td>
                        <td>
		                      <div class="btn-group">
		                        <a href="<?php echo U('Lianxi/edit',array('id'=>$value['id']));?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
		                        <a onclick="return confirm('确定要删除吗？');" href=" <?php echo U('Lianxi/del',array('id'=>$value['id']));?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicons glyphicon-trash"></span></a>
		                      </div>
